...
*/
  ...
  define('MODULE_BOXES_REVIEWS_BOX_WRITE_REVIEW', 'Donnez votre avis pour ce produit !');
  define('MODULE_BOXES_REVIEWS_BOX_NO_REVIEWS', 'Il n\'y a pas encore d\'avis pour ce produit');
