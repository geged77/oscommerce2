...
class inpay
{
    ...
    function install()
    {
		...
		$sort_order = 0;
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Utiliser inpay sur votre site?', 'MODULE_PAYMENT_INPAY_STATUS', 'False', '', '6', '".$sort_order++."', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Serveur', 'MODULE_PAYMENT_INPAY_GATEWAY_SERVER', 'Production', 'Utiliser le serveur de test (testing) ou de production ? ', '6', '".$sort_order++."', 'tep_cfg_select_option(array(\'Production\', \'Test\'), ', now())");
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Votre id marchand (merchant id)', 'MODULE_PAYMENT_INPAY_MERCHANT_ID', '', 'Votre identifiant unique de marchand (fourni par inpay)', '6', '".$sort_order++."', now())");
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Votre clé secrète', 'MODULE_PAYMENT_INPAY_SECRET_KEY', '', 'Votre clé (fournie par inpay)', '6', '".$sort_order++."', now())");
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Page de paiement', 'MODULE_PAYMENT_INPAY_FLOW_LAYOUT', 'multi_page', 'Page pour le paiement', '6', '".$sort_order++."', now())");
        
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Déduire les produits du stock à la création de la commande', 'MODULE_PAYMENT_INPAY_DECREASE_STOCK_ON_CREATION', 'False', 'Voulez-vous déduire les produits du stock dès le début de la procédure de paiement?', '6', '".$sort_order++."', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Adresse mail de debug', 'MODULE_PAYMENT_INPAY_DEBUG_EMAIL', '', 'Tous les paramètre de défaut IPN seront envoyés à cette adresse si elle stipulée.', '6', '".$sort_order++."', now())");
        
        
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Payment Zone', 'MODULE_PAYMENT_INPAY_ZONE', '0', 'Si une zone est sélectionnée, elle sera la seule à accéder à ce module.', '6', '".$sort_order++."', 'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
        ...
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ordre d\'affichage.', 'MODULE_PAYMENT_INPAY_SORT_ORDER', '0', 'Ordre d\'affichage dans la page. Le plus petit en premier. ', '6', '".$sort_order++."', now())");
