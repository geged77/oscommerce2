...
*/
  ...
  class ar_contact_us {
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Minutes de latence entre 2 mails', 'MODULE_ACTION_RECORDER_CONTACT_US_EMAIL_MINUTES', '15', 'Durée pendant laquelle l\'envoi d\'un nouveau mail est impossible : ex. 5 pour obliger un délai de 5 minutes entre chaque mail', '6', '0', now())");
    }
