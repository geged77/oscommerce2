...
*/
  ...
  class d_orders {
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Activer le module commandes', 'MODULE_ADMIN_DASHBOARD_ORDERS_STATUS', 'True', 'Voulez-vous afficher les dernières commande sur le panneau d\'administration?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ordre d\'affichage', 'MODULE_ADMIN_DASHBOARD_ORDERS_SORT_ORDER', '0', 'Ordre d\'affichage, le plus petit en premier.', '6', '0', now())");
    }
